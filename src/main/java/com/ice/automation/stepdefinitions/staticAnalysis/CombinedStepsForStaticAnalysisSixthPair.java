...
public class CombinedStepsForStaticAnalysisSixthPair {
    @Autowired
    ...
    public void pairSixScenarioOneWithoutRearrangement(String msisdn, String message, String reply) throws Throwable {
userAttributes.setMsisdn(msisdn);
    ...
    public void pairSixScenarioTwoWithRearrangement(String msisdn, String message, String reply) throws Throwable {
        userAttributes.setMsisdn(msisdn);
