...
public class CombinedStepsForStaticAnalysisFifthPair {
    @Autowired
    ...
    public void pairFiveScenarioOneWithoutRearrangement(String msisdn, String message, String reply) throws Throwable {
    ...
    public void pairFiveScenarioTwoWithRearrangement(String msisdn, String message, String reply) throws Throwable {
userAttributes.setMsisdn(msisdn);
