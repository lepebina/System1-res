...
public class CombinedStepsForStaticAnalysisNinethPair {
    ...
    public void pairNineScenarioOneWithoutRearrangement(String msisdn, String message, String reply) throws Throwable {
    ...
    public void pairNineScenarioTwoWithRearrangement(String msisdn, String message, String reply) throws Throwable {
