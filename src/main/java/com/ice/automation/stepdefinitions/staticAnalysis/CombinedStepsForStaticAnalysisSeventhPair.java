...
public class CombinedStepsForStaticAnalysisSeventhPair {
    @Autowired
    ...
    public void pairSevenScenarioOneWithoutRearrangement(String msisdn, String message, String reply) throws Throwable {
userAttributes.setMsisdn(msisdn);
    ...
    public void pairSevenScenarioTwoWithRearrangement(String msisdn, String message, String reply) throws Throwable {
userAttributes.setMsisdn(msisdn);
