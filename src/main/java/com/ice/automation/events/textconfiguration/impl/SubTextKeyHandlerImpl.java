...
@Service("subTextKeyHandlerImpl")
public class SubTextKeyHandlerImpl implements TextKeyHandler {
    ...
    private String getUrl()   {
        return String.format("http://%s:%s/%s/%s/%s?msisdn=%s&language=%s",
                host,
                port,
                textKeyEvent.getApiUrl(),
                textKeyEvent.getTextKey(),
                textKeyEvent.getSubId(),
